...
#: it - alongside core's own root - to ``mainframe_artifacts.logging_setup.configure_logging``;
...
# own. The application (see mainframe_artifacts.logging_setup, used by the CLI) decides what
